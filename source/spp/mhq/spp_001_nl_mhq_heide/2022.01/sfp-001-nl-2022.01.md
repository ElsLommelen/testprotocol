...
```
## Wijzigingen t.o.v. vorige versies {#sfp-001-nl-wijzigingen-t.o.v.-vorige-versies}
...
::: figure
`<img src="media/vervangingsprocedure_1_stap1_metraster.png" alt="Centroïde van geselecteerde steekproefeenheid (geel) en mogelijke vervangende rastercellen met relatief rangnummer" width="100%" />`{=html}
```{=html}
<p class="caption">
```
...
::: figure
`<img src="media/vervangingsprocedure_1_stap2_bis_metraster.png" alt="De geselecteerde steekproefeenheid (met gele centroïde) is niet geschikt. De rastercellenn worden in volgorde afgelopen en beoordeeeld tot een geschikte rastercel wordt gevonden" width="100%" />`{=html}
```{=html}
<p class="caption">
```
...
::: figure
`<img src="media/vervangingsprocedure_geenvervangpunt.png" alt="Het doelhabitat is aanwezig in de polygoon maar er is geen enkel vervangpunt dat binnen het doelhabitat valt" width="100%" />`{=html}
```{=html}
<p class="caption">
```
...
```
##  Bijlagen {#sfp-001-nl--bijlagen .unnumbered}
...
```
##  Subprotocols {#sfp-001-nl--subprotocols .unnumbered}
